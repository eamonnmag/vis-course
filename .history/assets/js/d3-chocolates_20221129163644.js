    ...
    return {
        loadAndDisplay: function
            ...
            d3.json("assets/data/chocolate.json").then(function (data) {
                ...
                xAxis = d3.axisBottom(x).tickPadding(2);
                ...
                const gX = g.append("g").attr("class", "x axis").attr("transform", "translate(0," + y.range()[0] + ")").call(xAxis);
                ...
                const handleZoom = function(e) {
                    ...
                    gX.call(xAxis.scale(e.rescaleX(x)));
                    gY.call(yAxis.scale(e.rescaleY(y)));
                    g.selectAll(".chocolatenode").attr('transform', e.transform)
                };
